    ...
    public void onBindViewHolder(@NonNull ViewHolderAvatar viewHolderAvatar, int i) {
        ...
        if (Utilidades.avatarIdSeleccion==0){
            if (posicionMarcada==i){
                viewHolder.barraSeleccion.setBackgroundColor(vista.getResources().getColor(R.color.CardViewTransacciones0));
            }else{
                viewHolder.barraSeleccion.setBackgroundColor(vista.getResources().getColor(R.color.colorWhite));
            }
        }else{
